...
export class CardDemoComponent implements OnInit {
  public items: any[] = [
    ...
    {
      imageUrl: 'https://giftdibs.s3.amazonaws.com/5bd26b69be29a6f2123a5ec5-4wcUnFjdxxTL7MLxjcMIDcP05GeutBcx',
      name: 'LEGO Slave I',
      price: 199
    },
    {
      imageUrl: 'https://giftdibs.s3.amazonaws.com/5bd26b69be29a6f2123a5ec6-rtP5c6xNUYaUwI4pPB9s9GPCRMfLThGI',
      name: 'Charleston print',
      price: 19
    },
    {
      imageUrl: 'https://giftdibs.s3.amazonaws.com/5bd26b69be29a6f2123a5ec6-QURQEDvurjsA92bWyeGmqanfdZJ0zqMU',
